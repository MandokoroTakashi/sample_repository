...
// $sample = new Player();
// echo $sample -> jankenConverter(1); //動作済み
...
// $sample = new Me('政所','崇',2);
// echo $sample-> getName(); //動作済み
// echo $sample-> getChoice(); //動作済み
